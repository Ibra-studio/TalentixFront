...
const data30Days = [
  { date: "13 Avr", site: 0, manuel: 0 },
  { date: "15 Avr", site: 3, manuel: 0 },
  { date: "17 Avr", site: 0, manuel: 1 },
  { date: "19 Avr", site: 1, manuel: 0 },
  { date: "21 Avr", site: 3, manuel: 0 },
  { date: "23 Avr", site: 0, manuel: 0 },
  { date: "25 Avr", site: 2, manuel: 1 },
  { date: "27 Avr", site: 0, manuel: 0 },
  { date: "29 Avr", site: 1, manuel: 0 },
  { date: "03 Mai", site: 0, manuel: 0 },
  { date: "11 Mai", site: 0, manuel: 0 },
];

// 2. Données pour les 7 derniers jours
const data7Days = [
  { date: "05 Mai", site: 1, manuel: 0 },
  { date: "06 Mai", site: 2, manuel: 0 },
  { date: "07 Mai", site: 0, manuel: 1 },
  { date: "08 Mai", site: 3, manuel: 0 },
  { date: "09 Mai", site: 1, manuel: 0 },
  { date: "10 Mai", site: 0, manuel: 0 },
  { date: "11 Mai", site: 2, manuel: 0 },
];

// Configuration des canaux — volontairement limitée à 2 pour le MVP
// (voir note en bas de fichier pour l'évolution future)
const metricsConfig = [
  { key: "site", label: "Via le site carrière", color: "var(--color-brand)" },
  { key: "manuel", label: "Ajouté manuellement", color: "#FE8A6A" },
];
  ...
  return (
    <Card className="bg-card w-full overflow-hidden">
      <CardHeader className="flex flex-row items-center justify-between pb-4">
        <CardTitle className="text-sm font-medium">Candidats reçus</CardTitle>
      ...
      <CardContent className="pb-0 px-0">
        ...
        {/* Barre d'indicateurs cliquables — 2 colonnes seulement pour le MVP */}
...
// ─────────────────────────────────────────────────────────────
// NOTE POUR PLUS TARD (post-MVP, une fois le produit mature) :
// Réintroduire progressivement d'autres canaux dans metricsConfig
// et dans les objets de data30Days/data7Days, par exemple :
//   - { key: "sourcing", label: "Sourcé activement", color: "#FE8A6A" }
//   - { key: "cooptation", label: "Recommandé (cooptation)", color: "#a3e635" }
//   - { key: "email", label: "Via email", color: "#3b82f6" }
// Ne les ajouter que lorsque ces canaux existent réellement dans
// le produit (diffusion multi-jobboards, formulaire de cooptation, etc.),
// sinon les colonnes resteront vides et n'apporteront aucune valeur
// à l'utilisateur (cf. discussion sur la diffusion d'offres en V2).
// ─────────────────────────────────────────────────────────────